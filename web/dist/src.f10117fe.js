...
var Collection = /*#__PURE__*/_createClass(function Collection(rootUrl, deserialize) {
  var _this = this;

  var models = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : [];
  var events = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : new Eventing_1.Eventing();
...
function () {
  function Model(attributes, events, sync) {
    ...
    this.save = function () {
      _this.sync.save(_this.attributes.getAll()).then(function (resposne) {
        _this.trigger('save');
      }).catch(function () {
        _this.trigger('error');
      });
...
var UserList_1 = require("./views/UserList"); // const user = User.buildUser({ name: 'NAMEME', age: 20 })
